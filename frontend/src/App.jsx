...
export default function App() {
  const maxIntake = Math.max(...dailyIntakeByMeal.map((d) => d.value));
    ...
    <div className="app">
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom">
          <button className="btn-add-meal" id="openMealModal">
            食事を追加します
          </button>
        ...
        <section className="content">
            ...
            <div className="card">
              <div className="card-header">
                <div>
                  ...
                  {/* ページが「摂取」メインなので文言も合わせておく */}
                  <div className="subtitle">総摂取カロリー</div>
                </div>
              </div>
          ...
          <div className="row-single">
            <div className="card">
              <div className="card-header">
                <div>
                  <div className="card-title">今日の摂取カロリー内訳</div>
                  <div className="subtitle">朝・昼・夕・間食のバランス</div>
                </div>
              </div>

              <div className="fake-chart">
                {dailyIntakeByMeal.map((m) => (
                  <div
                    key={m.label}
                    className="bar"
                    style={{ height: `${(m.value / maxIntake) * 100}%` }}
                  />
                ))}
              </div>
              <div className="bar-labels">
